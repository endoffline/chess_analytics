...
class Timing(Base):
    ...
    threatened_pieces_white = Column(Float)
    threatened_pieces_count_white = Column(Float)
    ...
    threatened_guarded_pieces_white = Column(Float)
    threatened_guarded_pieces_count_white = Column(Float)
    ...
    threatened_pieces_black = Column(Float)
    threatened_pieces_count_black = Column(Float)
    ...
    threatened_guarded_pieces_black = Column(Float)
