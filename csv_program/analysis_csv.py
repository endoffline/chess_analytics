...
def main():
    ...
    for ply_number, mv in enumerate(act_game.mainline_moves(), start=1):
        ...
        print("threat_level: ", possible_moves_quality/possible_moves_count, possible_moves_quality, "/", possible_moves_count)
        # White player
        ...
        attacked_guarded_pieces_white = chess_analysis.compute_attacked_guarded_pieces(attack_moves_white, guard_moves_white)
        ...
        threats_weighted_count_white = chess_analysis.compute_threat_moves_weighted(board, attack_moves_white,
        ...
        attacked_guarded_pieces_black = chess_analysis.compute_attacked_guarded_pieces(attack_moves_black, guard_moves_black)
        ...
        threats_weighted_count_black = chess_analysis.compute_threat_moves_weighted(board, attack_moves_black,
        ...
        threats_weighted_white = chess_analysis.compute_threats_weighted(board, attack_moves_white,
                                                                         attacked_guarded_pieces_white)
        ...
        threats_weighted_black = chess_analysis.compute_threats_weighted(board, attack_moves_black,
                                                                         attacked_guarded_pieces_black)
        ...
        pawn_ending2 = chess_analysis.compute_pawn_ending(board)
        print("pawn_ending:",pawn_ending, pawn_ending2)
        ...
        counts["score_shift"].append(score_change)
        counts["score_shift_category"].append(score_change_category)
        ...
        counts["threatened_pieces_white"].append(', '.join(str(s) for s in chess_analysis.get_square_names(attacked_pieces_white)))
        counts["threatened_pieces_count_white"].append(attacked_pieces_count_white)
        ...
        counts["threatened_guarded_pieces_white"].append(', '.join(str(s) for s in chess_analysis.get_square_names(attacked_guarded_pieces_white)))
        counts["threatened_guarded_pieces_count_white"].append(attacked_guarded_pieces_count_white)
        ...
        counts["threatened_pieces_count_black"].append(attacked_pieces_count_black)
        ...
        counts["threatened_guarded_pieces_count_black"].append(attacked_guarded_pieces_count_black)
        ...
        counts["threatened_pieces_centipawn_white"].append(attacked_pieces_centipawn_white)
        counts["guarded_pieces_centipawn_white"].append(guarded_pieces_centipawn_white)
        counts["threatened_guarded_pieces_centipawn_white"].append(attacked_guarded_pieces_centipawn_white)
        counts["unopposed_threats_centipawn_white"].append(unopposed_threats_centipawn_white)
        counts["threatened_pieces_centipawn_black"].append(attacked_pieces_centipawn_black)
        counts["guarded_pieces_centipawn_black"].append(guarded_pieces_centipawn_black)
        counts["threatened_guarded_pieces_centipawn_black"].append(attacked_guarded_pieces_centipawn_black)
        ...
        counts["threatened_pieces_count_all"].append(attacked_pieces_count_white+attacked_pieces_count_black)
        ...
        counts["threatened_guarded_pieces_count_all"].append(attacked_guarded_pieces_count_white+attacked_guarded_pieces_count_black)
        counts["unopposed_threats_count_all"].append(unopposed_threats_count_white+unopposed_threats_count_black)
        counts["threatened_pieces_centipawn_all"].append(attacked_pieces_centipawn_white+attacked_pieces_centipawn_black)
        counts["guarded_pieces_centipawn_all"].append(guarded_pieces_centipawn_white+guarded_pieces_centipawn_black)
        counts["threatened_guarded_pieces_centipawn_all"].append(attacked_guarded_pieces_centipawn_white+attacked_guarded_pieces_centipawn_black)
